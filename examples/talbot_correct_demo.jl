...
using Plots
using Statistics
include(joinpath(@__DIR__, "talbot_correct.jl"))

function talbot_correct_demo()
    diam = 0.1
    period = 0.04
    ...
    plots = Plot[]
    for _ in 1:nseg
        wavefront, _ = prop_run(talbot_correct, wavelength_microns, n; PASSVALUE=Dict("diam" => diam, "period" => period, "dist" => z))
