...
| Polarization | `polaxis` | `0`, `10` | `full_hlc_polaxis_10` | Covered | Full HLC polarization-aberration row now matches the Python baseline at machine precision. |
| Zernikes | `zindex`, `zval_m` | default, nonzero coefficients | `full_hlc_zernike` | Covered | Full HLC injected-Zernike row now matches the Python baseline at machine precision. |
